...
class MenuItem extends Model
{
    ...
    {
        if ($this->model_class === 'Juzaweb\Models\Taxonomy') {
            $taxonomy = Taxonomy::find($this->model_id);
            return $taxonomy && !$taxonomy->trashed();
        } elseif ($this->model_class === 'Juzaweb\Backend\Models\Post') {
            
            $post = Post::find($this->model_id);
            
            return $post && !$post->trashed();
        }
