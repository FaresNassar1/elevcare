...
window.ajaxRequest = function ajaxRequest(url, data = null, options = {}) {
    let jqxhr = $.ajax({
...
window.replace_template =  function( template, data ) {
...
window.process_each = function process_each(elements, cb, timeout, options = {}) {
    let i = 0;
