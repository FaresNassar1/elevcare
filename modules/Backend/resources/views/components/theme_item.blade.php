        ...
        <div class="card-header border-bottom-0">
            <div class="d-flex">
                ...
                <div class="text-gray-6">
                    ...
                    <button class="btn btn-primary install-theme" data-theme="{{ $item->code }}"><i class="fa fa-check"></i> {{ trans_cms('cms::app.install') }}</button>
                    @else
                        <button class="btn btn-primary" disabled>
                            {{ trans_cms('cms::app.installed') }}
                        </button>
                    @endif
                    {{--<a href="javascript:void(0)" class="text-danger">{{ trans_cms('cms::app.delete') }}</a>--}}
                </div>
            </div>
        </div>
    </div>
