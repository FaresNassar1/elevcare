<div class="form-group form-taxonomy">
    ...
    <div class="form-add">
        <div class="form-group">
            <label class="col-form-label">{{ trans_cms('tadcms::app.name') }} <abbr>*</abbr></label>
            <input type="text" class="form-control" autocomplete="off">
        </div>

        <div class="form-group">
            <label class="col-form-label">{{ trans_cms('tadcms::app.parent') }}</label>
            <select type="text" class="form-control load-taxonomy" data-type="{{ $setting->get('type') }}" data-taxonomy="{{ $taxonomy }}">
            </select>
        </div>

        <button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> {{ trans_cms('tadcms::app.add') }}</button>
    </div>
</div>
