...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="mb-4">{{ trans_cms('cms::app.permalink_description', ['url' => url('/')]) }}</p>
            ...
            @component('cms::components.form', [
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="{{ $key }}-base">{{ $permalink->get('label') }} {{ trans_cms('cms::app.base') }}</label>
                    <div class="col-md-6">
