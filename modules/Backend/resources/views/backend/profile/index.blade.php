            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link @if(!isset($notification)) active @endif" href="#settings" data-toggle="tab">{{ trans_cms('cms::app.settings') }}</a></li>
                        <li class="nav-item"><a class="nav-link @if(isset($notification)) active @endif" href="#notifications" data-toggle="tab">{{ trans_cms('cms::app.notifications') }}</a></li>
                        <li class="nav-item text-capitalize"><a class="nav-link" href="#change-password" data-toggle="tab">{{ trans_cms('cms::app.change_password') }}</a></li>
                    </ul>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane @if(isset($notification)) active @endif" id="notifications">
                            @if(isset($notification))
                                <a href="{{ route('admin.profile') }}">
                                    <i class="fa fa-hand-o-left"></i> {{ trans_cms('cms::app.notifications') }}
                                </a>
