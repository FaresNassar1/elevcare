        ...
        <div class="col-md-6">
            <div class="btn-group float-right">
                @if(config('juzaweb.theme.enable_upload'))
                    <a href="{{ route('admin.theme.install') }}" class="btn btn-success" data-turbolinks="false"><i class="fa fa-plus-circle"></i> {{ trans_cms('cms::app.add_new') }}</a>
                @endif
            </div>
        </div>
    </div>
                    ...
                    <div class="card-header border-bottom-0">
                        <div class="d-flex">
                            ...
                            <div class="text-gray-6">
                                <button class="btn btn-secondary" disabled> {{ trans_cms('cms::app.activated') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
