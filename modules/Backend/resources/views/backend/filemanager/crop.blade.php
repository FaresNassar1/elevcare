    ...
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        ...
        <label class="btn btn-info btn-aspectRatio" onclick="changeAspectRatio(this, null)">
          {{ trans_cms('cms::filemanager.btn-crop-free') }}
        </label>
      </div>
      <br>
      <br>
      <div class="btn-group clearfix">
        <button class="btn btn-secondary" onclick="loadItems()">{{ trans_cms('cms::filemanager.btn-cancel') }}</button>
        <button class="btn btn-warning" onclick="performCropNew()">{{ trans_cms('cms::filemanager.btn-copy-crop') }}</button>
        <button class="btn btn-primary" onclick="performCrop()">{{ trans_cms('cms::filemanager.btn-crop') }}</button>
      </div>
      <form id='cropForm'>
