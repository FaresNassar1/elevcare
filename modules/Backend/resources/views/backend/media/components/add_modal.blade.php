            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @component('cms::components.form_input', [
                        'label' => trans_cms('cms::app.folder_name'),
                        'name' => 'name'
                    ])
                    @endcomponent
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i> {{ trans_cms('cms::app.close') }}</button>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> {{ trans_cms('cms::app.add_folder') }}</button>
                </div>
            </div>
        </form>
    </div>
