            ...
            <div class="modal-header">
                <h5 class="modal-title" id="upload-modal-label">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active text-capitalize" id="upload-tab" data-toggle="tab" href="#upload" role="tab" aria-controls="home" aria-selected="true">{{ trans_cms(('cms::app.upload_media')) }}</a>
                        </li>
                        @if(config('juzaweb.filemanager.upload_from_url'))
                        <li class="nav-item">
                            <a class="nav-link text-capitalize" id="import-tab" data-toggle="tab" href="#import" role="tab" aria-controls="profile" aria-selected="false">{{ trans_cms('cms::app.file_manager.upload_from_url') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-capitalize" id="external-tab" data-toggle="tab" href="#external" role="tab" aria-controls="profile" aria-selected="false">{{ trans_cms('cms::app.file_manager.external_url') }}</a>
                        </li>
                        @endif
                    </ul>
                </h5>
