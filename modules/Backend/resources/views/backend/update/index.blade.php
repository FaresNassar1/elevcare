                ...
                <div class="col-md-4">
                    <form method="post" class="form-inline">
                        ...
                        <select name="bulk_actions" class="form-control select2-default" data-width="120px">
                            ...
                            <option value="update">{{ trans_cms('cms::app.update') }}</option>
                        </select>

                        <button type="submit" class="btn btn-primary px-3" id="apply-action-plugins">{{ trans_cms('cms::app.apply') }}</button>
                    </form>
                </div>
            </div>
                ...
                <table class="table" id="plugins-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="plugin">{{ trans_cms('cms::app.plugin') }}</th>
                            <th data-field="current_version" data-width="10%">{{ trans_cms('cms::app.current_version') }}</th>
                            <th data-field="new_version" data-width="10%">{{ trans_cms('cms::app.new_version') }}</th>
                        </tr>
                    </thead>
                </table>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    <form method="post" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-primary px-3" id="apply-action-themes">{{ trans_cms('cms::app.apply') }}</button>
                    </form>
                </div>
            </div>
            ...
            <div class="table-responsive mb-5">
                <table class="table" id="themes-table">
                    <thead>
                        <tr>
                            <th data-field="state" data-width="3%" data-checkbox="true"></th>
                            <th data-field="theme">{{ trans_cms('cms::app.theme') }}</th>
                            <th data-field="current_version" data-width="10%">{{ trans_cms('cms::app.current_version') }}</th>
                            <th data-field="new_version" data-width="10%">{{ trans_cms('cms::app.new_version') }}</th>
                        </tr>
                    </thead>
