...
class BackupAction extends Action
{
    ...
    public function addConfigs(): void
    {
        $this->hookAction->registerConfig(
            [
                'jw_backup_enable' => [
                    'form' => 'backup',
                    'type' => 'select',
                    'label' => trans_cms('cms::app.backup.enable_backup'),
                    'data' => [
                        'options' => [
                            0 => trans_cms('cms::app.disabled'),
                            1 => trans_cms('cms::app.enabled'),
                        ]
                    ]
                ],
                'jw_backup_time' => [
                    'form' => 'backup',
                    'type' => 'select',
                    'label' => trans_cms('cms::app.backup.backup_time'),
                    'data' => [
                        'options' => [
                            'daily' => 'Daily',
                            'weekly' => 'Weekly',
        ...
        $this->hookAction->addSettingForm(
            'backup',
            [
                'name' => trans_cms('cms::app.backup.backup_setting'),
                'priority' => 99,
            ]
        );
    }
