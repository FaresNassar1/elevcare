...
class SeoSettingController extends Controller
{
    ...
    public function save(Request $request)
    {
        $this->validateRequest([
            ...
            'author_name' => trans_cms('cms::app.author_name'),
            'movies_title' => trans_cms('cms::app.movies_title'),
            'movies_keywords' => trans_cms('cms::app.movies_keywords'),
            'movies_description' => trans_cms('cms::app.movies_description'),
            'tv_series_title' => trans_cms('cms::app.tv_series_title'),
            'tv_series_keywords' => trans_cms('cms::app.tv_series_keywords'),
            'tv_series_description' => trans_cms('cms::app.tv_series_description'),
            'blog_title' => trans_cms('cms::app.blog_title'),
            'blog_keywords' => trans_cms('cms::app.blog_keywords'),
            'blog_description' => trans_cms('cms::app.blog_description'),
            'facebook' => 'Facebook URL',
            'twitter' => 'Twitter URL',
            'pinterest' => 'Linkedin URL',
            'youtube' => 'Youtube URL',
            'title' => trans_cms('cms::app.home_title'),
            'description' => trans_cms('cms::app.home_description'),
            'keywords' => trans_cms('cms::app.keywords'),
        ]);
