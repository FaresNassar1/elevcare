...
class CommentSettingController extends Controller
{
    public function index()
    {
        return view(
            ...
            [
                'title' => trans_cms('cms::app.comment_setting'),
            ]
        );
    }
    ...
    public function save(Request $request)
    {
        $this->validateRequest(
            ...
            $request,
            [
                'comment_able' => trans_cms('cms::app.comment_able'),
                'comment_type' => trans_cms('cms::app.comment_type'),
                'comments_per_page' => trans_cms('cms::app.comments_per_page'),
                'comments_approval' => trans_cms('cms::app.comments_approval'),
            ]
        );
