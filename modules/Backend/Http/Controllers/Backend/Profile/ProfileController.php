...
class ProfileController extends BackendController
{
    ...
    public function index(): View
    {
        ...
        $title = trans_cms('cms::app.profile');
    ...
    public function update(ProfileUpdateRequest $request): JsonResponse|RedirectResponse
    {
        ...
        $metas = array_only($request->post('metas'), ['country']);
        ...
        return $this->success(trans_cms('cms::message.update_successfully'));
    }
    ...
    public function changePassword(ChangePasswordRequest $request): JsonResponse|RedirectResponse
    {
        ...
        if (!Hash::check($current, $user->password)) {
            return $this->error(trans_cms('validation.current_password'));
        }
        ...
        $content = [
            ...
            'id' => $user->id,
            'type' => "user",
            'label' => "changed profile password",
            'title' => "",
            'path' => "",
        ];
        log_action($content);
        return $this->success(
            trans_cms('cms::message.change_password_successfully')
        );
    }
