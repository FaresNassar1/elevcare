...
class PostRepositoryEloquent extends BaseRepositoryEloquent implements PostRepository
{
    ...
    {
        $statuses = [
            Post::STATUS_PUBLISH => trans_cms('cms::app.publish'),
            Post::STATUS_PRIVATE => trans_cms('cms::app.private'),
            Post::STATUS_DRAFT => trans_cms('cms::app.draft'),
            Post::STATUS_TRASH => trans_cms('cms::app.trash'),
        ];
