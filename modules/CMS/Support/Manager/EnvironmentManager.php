...
class EnvironmentManager
{
    ...
    {
        $message = trans_cms('cms::installer.environment.success');

        try {
            file_put_contents($this->envPath, $input->get('envConfig'));
        } catch (Exception $e) {
            $message = trans_cms('cms::installer.environment.errors');
        }
    ...
    {
        $results = trans_cms('cms::installer.environment.success');
        $url = url('/');
        ...
        try {
            ...
            $results = trans_cms('cms::installer.environment.errors');
        }
