...
class DatabaseManager
{
    ...
    private function migrate(BufferedOutput $outputLog): array
    {
        ...
        return $this->response(trans_cms('cms::installer.final.database_finished'), 'success', $outputLog);
    }
    ...
    {
        DbConfig::setConfig('title', 'Progmix CMS');
        DbConfig::setConfig(
            'description',
            'Progmix Content Management System (CMS)'
        );
        DbConfig::setConfig('author_name', 'Progmix');
