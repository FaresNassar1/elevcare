...
use Progmix\Api\Http\Middleware\CalculateRequestDuration;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'frontend'=>[
            ...
            'locale' => \Juzaweb\Frontend\Http\Middleware\Locale::class,
            'XssSanitization' => \Juzaweb\Backend\Http\Middleware\XssSanitization::class,
            'throttle' => \Illuminate\Routing\Middleware\ThrottleRequests::class,
        ],

        'api' => [
            // 'CalculateRequestDuration' => \Juzaweb\Backend\Http\Middleware\CalculateRequestDuration::class,
            \Juzaweb\CMS\Http\Middleware\GlobalMiddleware::class,
    ...
    protected $routeMiddleware = [
        ...
        'locale' => \Juzaweb\Frontend\Http\Middleware\Locale::class,
        'XssSanitization' => \Juzaweb\Backend\Http\Middleware\XssSanitization::class,
        'SecurityHeaders' => \Juzaweb\Backend\Http\Middleware\SecurityHeaders::class,
        'csp' => \Spatie\Csp\AddCspHeaders::class,
        'CalculateRequestDuration' => CalculateRequestDuration::class,
    ];
}
