...
class User extends Authenticatable
{
    ...
    {
        return [
            User::STATUS_ACTIVE => trans_cms('cms::app.active'),
            User::STATUS_BANNED => trans_cms('cms::app.banned'),
            User::STATUS_VERIFICATION => trans_cms('cms::app.verification'),
        ];
    }
