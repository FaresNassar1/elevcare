...
class CreateConfigsTable extends Migration
{
    ...
    private function _createConfig()
    {
        ...
        Config::setConfig('location', '');
        Config::setConfig('phone', '');
        Config::setConfig('contact_email', '');
        Config::setConfig('site_keywords', '');
        Config::setConfig('map_link', '');
        Config::setConfig('cache_duration', '');
