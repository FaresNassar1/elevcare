                ...
                <table class="table juzaweb-table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th data-field="title">{{ trans_cms('cms::app.name') }}</th>
                            <th data-field="type" data-width="15%">{{ trans_cms('cms::app.type') }}</th>
                            <th data-width="20%" data-formatter="actions_formatter">{{ trans_cms('cms::app.actions') }}</th>
                        </tr>
                    </thead>
                </table>
            </div>
