<div class="juzaweb__topbar">
    <div class="mr-3">
        <a href="{{ route('admin.dashboard') }}" class="mr-2" title="{{ trans_cms('cms::app.dashboard') }}" data-turbolinks="false">
            <i class="dropdown-toggle-icon fa fa-dashboard" data-toggle="tooltip" data-placement="bottom" data-original-title="Visit website"></i> {{ trans_cms('cms::app.admin') }}
        </a>

        <a href="{{ url('/') }}" class="mr-2" target="_blank" title="{{ trans_cms('cms::app.view_site') }}">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" role="menu">
            ...
            <a href="javascript:void(0)" data-turbolinks="false" class="dropdown-item auth-logout">
                <i class="dropdown-icon fe fe-log-out"></i> {{ trans_cms('cms::app.logout') }}
            </a>
        </div>
    </div>
</div>
