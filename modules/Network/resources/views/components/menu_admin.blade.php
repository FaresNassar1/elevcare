<div class="mr-3">
    <div class="dropdown d-none d-sm-block">
        <a href="javascript:void(0)" class="dropdown-toggle text-nowrap" data-toggle="dropdown">
            ...
            <span class="dropdown-toggle-text"> {{ trans_cms('cms::app.network.network') }}</span>
        </a>
        ...
        <div class="dropdown-menu" role="menu">
            ...
            <a
                ...
                data-turbolinks="false"
            >{{ trans_cms('cms::app.network.sites') }}</a>

            <a
                class="dropdown-item"
                href="{{ route('admin.network.themes.index') }}"
                data-turbolinks="false"
            >{{ trans_cms('cms::app.themes') }}</a>

            <a
                class="dropdown-item"
                href="{{ route('admin.network.plugins.index') }}"
                data-turbolinks="false"
            >{{ trans_cms('cms::app.plugins') }}</a>
        </div>
    </div>
</div>
