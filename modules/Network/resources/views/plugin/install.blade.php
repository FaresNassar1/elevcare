                ...
                <div class="form-group">
                    <div class="controls text-center">
                        <div class="input-group w-100">
                            <a class="btn btn-primary w-100 text-white" id="plugin-upload-button">{{ trans_cms('cms::filemanager.message-choose') }}</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4 text-right">
            <button type="button" class="btn btn-success" id="upload-plugin">
                {{ trans_cms('cms::app.upload_plugin') }}
            </button>
        </div>
    </div>
            ...
            <div class="card p-3">
                ...
                <div class="d-flex justify-content-between install mt-3">
                    ...
                    <button
                        ...
                        data-plugin="{name}"
                    >{{ trans_cms('cms::app.install') }}</button>

                    {{--<a target="_blank" href="{url}" class="text-primary">
                        {{ trans_cms('cms::app.view') }}&nbsp;<i class="fa fa-angle-right"></i>
                    </a>--}}
                </div>
            </div>
        </div>
