...
class Site extends Model implements RootNetworkModelInterface
{
    ...
    {
        return [
            self::STATUS_ACTIVE => trans_cms('cms::app.active'),
            self::STATUS_INACTIVE => trans_cms('cms::app.active'),
            self::STATUS_VERIFICATION => trans_cms('cms::app.verification'),
            self::STATUS_BANNED => trans_cms('cms::app.banned'),
        ];
    }
