...
class SwaggerDocument implements Arrayable
{
     ...
     * @return $this
     */
    public function setTitle(string $title,string $description): static
    {
        $this->title = $title;
    ...
    public function appendSecurity(string $schemeName, array $scopes = []): self
    {
        $security = [
            $schemeName => $scopes,
        ];
